...
namespace Cliente_v2
{
    public partial class Cliente : Form
    {
        ...
        private bool EstaConectado(Socket socket) //funcion que comprueba si el socket está conectado
        {
            try
            {
        ...
        private void conectar_Click(object sender, EventArgs e)
        {
            ...
            IPEndPoint ipep = new IPEndPoint(direc, 9060); //INDICAMOS PUERTO// El puerto establecido es un ejemplo
            ...
            try
            {
                ...
                MessageBox.Show("Conexión con el servidor aceptada");
        ...
        private void iniciar_sesion_Click(object sender, EventArgs e)
        {
            ...
            buscar en la base de datos al usuario y enviar un mensaje de vuelta que ponga que SI esta. */
                ...
                {
                    MessageBox.Show("Error al iniciar sesion, nombre o contraseña erroneos");

                }
            }
            else
            {
                MessageBox.Show("La conexión no está activa. Por favor, conéctate primero.");
            }
