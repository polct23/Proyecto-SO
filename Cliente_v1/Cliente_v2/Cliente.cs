...
namespace Cliente_v2
{
    public partial class Cliente : Form
    {
        ...
        {
            string mensaje = "1/" + textUsuario.Text + "/" + textContraseña.Text; /*EL mensaje 1 servira para iniciar sesion, el servidor tendra que
        ...
        {
            string mensaje = "2/" + textUsuario.Text + "/" + textContraseña.Text; /*EL mensaje 2 servira para registrarse, el servidor tendra que
