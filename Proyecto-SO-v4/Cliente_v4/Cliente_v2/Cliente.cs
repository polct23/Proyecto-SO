...
namespace Cliente_v2
{
    ...
    public partial class Cliente : Form
    {
        ...
        Thread atender;
        //ips y puertos
        string IpShiva = "10.4.119.5";
        string IpVirtual = "192.168.56.102";
        int puertoShiva = 50082;
        int puertoVirtual = 9070;
        public Cliente()
        {
            InitializeComponent();
        ...
        {
            IPAddress direc = IPAddress.Parse(IpVirtual); //INDICAMOS IP// La ip establecida es un ejemplo
            IPEndPoint ipep = new IPEndPoint(direc, puertoVirtual); //INDICAMOS PUERTO// El puerto establecido es un ejemplo
